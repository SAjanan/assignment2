...
public class q28 {
	...
	class Project{      // has Default arr
	    ...
	    private LinkedList<q28> df = new LinkedList<q28>();
	    String name;
	    String id;
	    ...
	    public void createDefect(String defId, String description){
	        q28 dfa = new q28(defId , description);
	        this.df.add(dfa);
	    }
	    void giveStatus(String defId){
	        q28 deff = this.df.get(defIdforId(defId));
